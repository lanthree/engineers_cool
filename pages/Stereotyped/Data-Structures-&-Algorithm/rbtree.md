...
![删除 黑色 无子结点的结点 的情况](https://engineers-cool-1251518258.cos.ap-chengdu.myqcloud.com/rbtree_delete_1_2_note.svg)
...
另外，记`h(A->B->NIL)`表示从A走到B再走到某一个叶子结点（NIL结点）的黑色结点数量。
